...
import com.tosinorojinmi.theophilus.agriwaves.Adapters.CategoryRecyclerAdapter;
...
public class CategoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            ...
            categoryRecyclerAdapter = new CategoryRecyclerAdapter(categoryArrayList, getContext());
            //categoryRecyclerAdapter.setCategoryArrayList(categoryArrayList);
            ...
            getJsonCategoryTask(new VolleyCallBack() {
                ...
                public void onSuccess(ArrayList<Category> category) {
                    ...
                    categoryRecyclerAdapter = new CategoryRecyclerAdapter(category, getContext());
                    recyclerView.setAdapter(categoryRecyclerAdapter);
                }
            });
        }
    ...
    private void getJsonCategoryTask(final VolleyCallBack volleyCallBack){
        String URL_STRING           = Helpers.URL_STRING + "/category";
